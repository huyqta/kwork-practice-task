...
using KworkPracticeTask.Sessions;
using KworkPracticeTask.Web.Models.Account;
using KworkPracticeTask.Web.Views.Shared.Components.TenantChange;

namespace KworkPracticeTask.Web.Controllers
{
    public class AccountController : KworkPracticeTaskControllerBase
    {
